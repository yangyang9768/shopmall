<template>
  <div>
    ...
    <el-dialog
      ...
      :show-close="false"
    >
      <button style="position:absolute;top:5%;left:90%;" @click="$emit('close')">X</button>
  ...
  data() {
    return {
      ...
      form: {
        ...
        detailaddress: this.addinfo.detailaddress,
        default: this.addinfo.default,
    ...
    address() {
      ...
      if (a === true && b === true) {
        if (reg.test(tel)) {
          ...
          //   nickname: ""
          // };
          // this.province = { province: "", city: "", area: "" };
          this.$emit("close");
          for (let i = 0; i < 3; i++) {
            this.ruleForm.district[Object.keys(this.ruleForm.district)[i]] = "";
          }
